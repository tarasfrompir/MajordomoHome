...
$this->device_types['Zigbysmoke'] = array(
    ...
    'PROPERTIES'=>array(
        ...
        'activity'=>array('DESCRIPTION'=>'Состояние устройства 1-активно, 0-неактивно', 'KEEP_HISTORY'=>7), //обязателен для бинарных сенсоров 
    ...
    'METHODS'=>array(
		'updateDeviceData'=>array('DESCRIPTION'=>'Обновление всех свойств устройства из сырых данных allproperties'),
